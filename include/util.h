...
namespace util
{
    ...
    inline Vector3f TransformToNormal(Vector3f normal, Eigen::Matrix4f Transformation)
    {
        return Transformation.block(0, 0, 3, 3) * normal;
    }

    inline Vector3f TransformToVertex(Vector3f vertex, Eigen::Matrix4f Transformation)
    {   
